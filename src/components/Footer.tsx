...
const Footer = () => {
  ...
  const courses = [
    ...courseData.map((c) => ({ name: c.name, href: "/courses" })),
  ];
        ...
        <div className="py-12 sm:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-sm leading-relaxed mb-6 text-gray-400">
              Professional mentorship for Melbourne tradies seeking BPC building registration. Small classes, personalised teaching.
            </p>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                   <div className="text-xs text-gray-500 mb-0.5">Opening Hours</div>
                    <div className="text-sm text-white font-medium">9am–9pm</div>
                </div>
              </li>
            </ul>
          </div>
