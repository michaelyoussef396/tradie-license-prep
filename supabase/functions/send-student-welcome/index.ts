  ...
  try {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 30px; background: #ffffff;">
        ...
        <p style="font-size: 16px; color: #333;">Share this code with any tradie mates who need their BPC registration. When they enrol using your code, <strong>you'll earn a $300 referral reward</strong> and <strong>they'll get $100 off</strong> their course.</p>
